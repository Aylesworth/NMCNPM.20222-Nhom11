...
import com.aylesw.mch.backend.model.AuthCode;
...
import com.aylesw.mch.backend.repository.AuthCodeRepository;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    private String generateAuthCode(String userEmail, String usedFor) {
        ...
        if (authCodeRepository.findByValueUnexpiredAtTime(value, Timestamp.valueOf(LocalDateTime.now())).isPresent())
        ...
        AuthCode authCode = AuthCode.builder()
                ...
                .userEmail(userEmail)
                .usedFor(usedFor)
                .expiresAt(Timestamp.valueOf(LocalDateTime.now().plusSeconds(120)))
                .used(false)
                .build();
        authCodeRepository.save(authCode);
